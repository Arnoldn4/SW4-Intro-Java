public class Vehicle {
    public static void main(String[] args) {
        // data type
        // object = vehicle car, vehicle type, series, fuel, name
        // datatype variable_name = value;

        // create an object, declare at least 3 variables using different data types and print
        String name = "BMW";
        String vehicleType = "Car"; // String = text value
        int carSeries = 7; // int = integer = whole number
        double vehicleFuel = 2.5;  // double = fraction
